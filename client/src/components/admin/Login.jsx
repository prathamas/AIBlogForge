        ...
        <div className='flex flex-col items-center justify-center'>
            ...
            <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
                <div className='flex flex-col'>
                    ...
                    className='border-b-2 border-gray-300 p-2 outline-none mb-6  text-gray-500' type="email" required placeholder='your email id'/>

                </div>
                <div className='flex flex-col'>
                    <label > Password </label>
                    <input onChange={e=> setPassword(e.target.value)} value={password}
                    className='border-b-2 border-gray-300 p-2 outline-none mb-6 text-gray-500' type="password" required placeholder='your password'/>
