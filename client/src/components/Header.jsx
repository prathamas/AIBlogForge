  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Your owm <span className='text-primary'>blogging</span> <br />platform.</h1>
            ...
            border border-gray-300 bg-white rounded overflow-hidden '>
                <input  ref={inputRef} type="text" placeholder='Search for blogs' required className='w-full pl-4 outline-none text-gray-500'/>
